		...
		if($update != null){
          ...
          $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendMessage([
                  'chat_id'=>$chatId,
                  'text'=>"• اهلن بك في اداة 𝗦𝗢𝗙𝗘 🔥 لصيد متاحات انستقرام بكل السهوله 😎🤘
~ @YYlYYYY @C3_B2 🍂",
		       ...
		       'chat_id'=>$chatId,
                ...
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'𝗦𝗢𝗙𝗘 🧑🏻‍💻','url'=>'t.me/YYlYYYY'],['text'=>'𝐌𝐘 𝐁𝐎𝐓𝐒 🔊','url'=>'t.me/WVWWWQ']]
                      ]
                  ])
               ]);
           } if($text == '- عربي 👁'){
		       ...
		       'chat_id'=>$chatId,
                ...
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'مطور البوت 👨🏻‍💻','url'=>'t.me/YYlYYYY'],['text'=>'قناة البوت 🔊','url'=>'t.me/WVWWWQ']]
                      ]
                  ])
               ]);
...
طريقة عمل بوت الصيد هيه انك تقوم بجمع يوزرات من الانستقرام ووضعها بالبوت ويقوم بالتخمين على المتابعين او الذين يقوم بمتابعتهم حسب اختيار بالطبع هناك طرق اخرى للسحب عبر هاشتاق متلا او كلمات بالبحث",
          	...
          	if($config['mode'] != null){
                  ...
                  'reply_markup'=>json_encode([
				    ...
				    $bot->sendvideo([
       'chat_id'=>$chatId,
       'video'=> "https://t.me/bJJJJ4/2",
        'caption'=>'👨🏻‍💻- مرحبا عزيزي البوت مدفوع وليس مجاني
- لطلب تفعيل بوت صيد او ملفات يرجا مراسلة المطور 👇',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/YYlYYYY']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/WVWWWQ"]]
                  ]
							])
					]);
				}
