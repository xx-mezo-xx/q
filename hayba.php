...
public function Gmail($UseName){
    ...
    public function Yahoo($UseName)
    {
        ...
        curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36");
        curl_setopt($c, CURLOPT_REFERER, 'https://login.yahoo.com/?.src=ym&.lang=en-US&.intl=us&.done=https%3A%2F%2Fcompose.mail.yahoo.com%2Fmrd%2F');
        ...
        $header[] = "Referer: https://login.yahoo.com/?.src=ym&.lang=en-US&.intl=us&.done=https%3A%2F%2Fcompose.mail.yahoo.com%2Fmrd%2F";
    ...
    {
        $fromemail = 'aliahmed59005336@gmail.com';
        $details = '';
